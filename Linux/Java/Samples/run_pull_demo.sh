...
javac -d . -cp ${JAR_PATH}/ding_rtc_linux_java.jar:${JAR_PATH}/json-20131018.jar -encoding utf-8 LinuxServerPullDemo.java

java -cp .:${JAR_PATH}/ding_rtc_linux_java.jar:${JAR_PATH}/json-20131018.jar samples/LinuxServerPullDemo
