// Modified from mini_chromium/base/files/file_path.cc
// @author yuqilin
// 
...
std::ostream& operator<<(std::ostream& os, const tlog::FilePath& file_path) {
#ifdef FILE_PATH_USES_WIDE_CHARACTERS
  return os << tlog::WideToUTF8(file_path.value());
#else
