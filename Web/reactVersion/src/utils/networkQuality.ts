import DingRTC, { CameraVideoTrack, NetworkQuality, RemoteUser, TrackMediaType } from 'dingrtc';
import { getAppToken } from './request';
import configJson from '~/config.json';
import { Toast } from 'dingtalk-design-desktop';
...
const uplinkClient = DingRTC.createClient();
const downlinkClient = DingRTC.createClient();
