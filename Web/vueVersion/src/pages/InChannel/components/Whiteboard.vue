  ...
  <div class="dingrtc-wb-wrapper">
    <div class="dingrtc-wb" ref="wrapDomRef">
      <div class="whiteboard-container" ref="domRef">
        <Toolbar :isHost="true" :whiteboard="whiteboard"  />
        <VisionShare :whiteboard="whiteboard" />
        <ToolPagination :isHost="true" :activeDocId="activeDocId" :whiteboard="whiteboard"  />
      </div>
    </div>
  </div>
</template>
...
onMounted(() => {
  ...
  channelInfo.whiteboard.open(domRef.value!);
  updateWbDomSize();
  setTimeout(() => {
