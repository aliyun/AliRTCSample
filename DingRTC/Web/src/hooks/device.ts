...
export const useDevice = (scene?: 'pre' | 'in') => {
  ...
  const [
    { cameraId, micId, cameraDimension, cameraFrameRate, screenDimension, screenFrameRate },
    setDeviceInfo,
  ...
  }, [cameraDimension, cameraFrameRate]);
  ...
  }, [cameraId, cameraDimension, cameraFrameRate]);
  ...
  }, [loading, screenDimension, screenFrameRate]);
