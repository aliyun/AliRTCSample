...
public class MultiViewRenderLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_multiview_render);
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (getMissedPermission().size() == 0) {
                    ...
                    Toast.makeText(MultiViewRenderLoginActivity.this, "Some permissions are denied", Toast.LENGTH_LONG).show();
                }
                break;
            default:
    ...
    private void joinChannel() {
        ...
        if (missed.size() != 0) {
            ...
            if (showRationale.size() > 0) {
                new AlertDialog.Builder(MultiViewRenderLoginActivity.this)
                        .setMessage("Please allow the permissions")
                        .setPositiveButton("OK", (dialog, which) ->
                                ActivityCompat.requestPermissions(MultiViewRenderLoginActivity.this,
    ...
    private void startCall(String channelId, String userId, String userName) {
        MultiViewRenderActivity.launch(MultiViewRenderLoginActivity.this, TokenGenerator.APP_ID, channelId,
