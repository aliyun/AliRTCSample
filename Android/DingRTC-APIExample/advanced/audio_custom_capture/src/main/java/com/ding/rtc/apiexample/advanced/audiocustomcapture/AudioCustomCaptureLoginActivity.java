...
public class AudioCustomCaptureLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_audio_custom_capture);
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (getMissedPermission().size() == 0) {
                    ...
                    Toast.makeText(AudioCustomCaptureLoginActivity.this, "Some permissions are denied", Toast.LENGTH_LONG).show();
                }
                break;
            default:
    ...
    private void joinChannel() {
        ...
        if (missed.size() != 0) {
            ...
            if (showRationale.size() > 0) {
                new AlertDialog.Builder(AudioCustomCaptureLoginActivity.this)
                        .setMessage("Please allow the permissions")
                        .setPositiveButton("OK", (dialog, which) ->
                                ActivityCompat.requestPermissions(AudioCustomCaptureLoginActivity.this,
    ...
    private void startCall(String channelId, String userId, String userName) {
        AudioCustomCaptureActivity.launch(AudioCustomCaptureLoginActivity.this, TokenGenerator.APP_ID, channelId,
