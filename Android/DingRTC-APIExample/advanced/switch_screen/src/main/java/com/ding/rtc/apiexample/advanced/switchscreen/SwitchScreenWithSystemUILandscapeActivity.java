...
public class SwitchScreenWithSystemUILandscapeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (config.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            setContentView(R.layout.activity_switch_screen_land_with_systemui_landscape);
        } else {
            setContentView(R.layout.activity_switch_screen_portrait_with_systemui_landscape);
        }
    ...
    private void addRemoteViewConfig(String uid) {
        SurfaceView localView = mRtcEngine.createRenderSurfaceView(SwitchScreenWithSystemUILandscapeActivity.this);
