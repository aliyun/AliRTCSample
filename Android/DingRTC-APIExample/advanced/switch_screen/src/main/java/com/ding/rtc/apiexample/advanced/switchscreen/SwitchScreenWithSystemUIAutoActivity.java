...
public class SwitchScreenWithSystemUIAutoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (config.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            setContentView(R.layout.activity_switch_screen_land_with_systemui_auto);
        } else {
            setContentView(R.layout.activity_switch_screen_portrait_with_systemui_auto);
        }
    ...
    private void addRemoteViewConfig(String uid) {
        SurfaceView localView = mRtcEngine.createRenderSurfaceView(SwitchScreenWithSystemUIAutoActivity.this);
