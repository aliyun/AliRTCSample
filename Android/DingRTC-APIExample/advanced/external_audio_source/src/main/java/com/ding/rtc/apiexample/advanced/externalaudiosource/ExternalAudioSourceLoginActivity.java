...
public class ExternalAudioSourceLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_external_audio_source);
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (getMissedPermission().size() == 0) {
                    ...
                    Toast.makeText(ExternalAudioSourceLoginActivity.this, "Some permissions are denied", Toast.LENGTH_LONG).show();
                }
                break;
            default:
    ...
    private void joinChannel() {
        ...
        if (missed.size() != 0) {
            ...
            if (showRationale.size() > 0) {
                new AlertDialog.Builder(ExternalAudioSourceLoginActivity.this)
                        .setMessage("Please allow the permissions")
                        .setPositiveButton("OK", (dialog, which) ->
                                ActivityCompat.requestPermissions(ExternalAudioSourceLoginActivity.this,
...
//        needPermissions.add(Manifest.permission.RECORD_AUDIO);
    ...
    private void startCall(String channelId, String userId, String userName) {
        ExternalAudioSourceActivity.launch(ExternalAudioSourceLoginActivity.this, TokenGenerator.APP_ID, channelId,
