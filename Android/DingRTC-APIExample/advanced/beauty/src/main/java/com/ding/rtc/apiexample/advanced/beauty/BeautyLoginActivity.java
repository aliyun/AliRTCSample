package com.ding.rtc.apiexample.advanced.beauty;
...
public class BeautyLoginActivity extends AppCompatActivity {
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (getMissedPermission().size() == 0) {
                    ...
                    Toast.makeText(BeautyLoginActivity.this, "Some permissions are denied", Toast.LENGTH_LONG).show();
                }
                break;
            default:
    ...
    private void joinChannel() {
        ...
        if (missed.size() != 0) {
            ...
            if (showRationale.size() > 0) {
                new AlertDialog.Builder(BeautyLoginActivity.this)
                        .setMessage("Please allow the permissions")
                        .setPositiveButton("OK", (dialog, which) ->
                                ActivityCompat.requestPermissions(BeautyLoginActivity.this,
    ...
    private void startCall(String channelId, String userId, String userName) {
        BeautyActivity.launch(BeautyLoginActivity.this, TokenGenerator.APP_ID, channelId,
