...
public class AudioVolumeIndicationLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_audio_volume_indication);
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (getMissedPermission().size() == 0) {
                    ...
                    Toast.makeText(AudioVolumeIndicationLoginActivity.this, "Some permissions are denied", Toast.LENGTH_LONG).show();
                }
                break;
            default:
    ...
    private void joinChannel() {
        ...
        if (missed.size() != 0) {
            ...
            if (showRationale.size() > 0) {
                new AlertDialog.Builder(AudioVolumeIndicationLoginActivity.this)
                        .setMessage("Please allow the permissions")
                        .setPositiveButton("OK", (dialog, which) ->
                                ActivityCompat.requestPermissions(AudioVolumeIndicationLoginActivity.this,
    ...
    private List<String> getMissedPermission() {
        ...
        // Important: Manifest.permission.RECORD_AUDIO is not required when using external audio source
    ...
    private void startCall(String channelId, String userId, String userName) {
        AudioVolumeIndicationActivity.launch(AudioVolumeIndicationLoginActivity.this, TokenGenerator.APP_ID, channelId,
