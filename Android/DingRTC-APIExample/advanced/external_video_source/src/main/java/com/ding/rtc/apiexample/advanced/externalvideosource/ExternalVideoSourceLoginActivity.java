...
public class ExternalVideoSourceLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_login_external_video_source);
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (getMissedPermission().size() == 0) {
                    ...
                    Toast.makeText(ExternalVideoSourceLoginActivity.this, "Some permissions are denied", Toast.LENGTH_LONG).show();
                }
                break;
            default:
    ...
    private void joinChannel() {
        ...
        if (missed.size() != 0) {
            ...
            if (showRationale.size() > 0) {
                new AlertDialog.Builder(ExternalVideoSourceLoginActivity.this)
                        .setMessage("Please allow the permissions")
                        .setPositiveButton("OK", (dialog, which) ->
                                ActivityCompat.requestPermissions(ExternalVideoSourceLoginActivity.this,
    ...
    private List<String> getMissedPermission() {
        ...
        // Important: Manifest.permission.CAMERA is not required when using external video source
    ...
    private void startCall(String channelId, String userId, String userName) {
        ExternalVideoSourceActivity.launch(ExternalVideoSourceLoginActivity.this, TokenGenerator.APP_ID, channelId,
