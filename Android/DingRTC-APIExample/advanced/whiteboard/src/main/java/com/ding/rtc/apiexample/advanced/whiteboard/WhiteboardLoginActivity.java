...
public class WhiteboardLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whiteboard_login);
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (getMissedPermission().size() == 0) {
                    ...
                    Toast.makeText(WhiteboardLoginActivity.this, "Some permissions are denied", Toast.LENGTH_LONG).show();
                }
                break;
            default:
    ...
    private void joinChannel() {
        ...
        if (missed.size() != 0) {
            ...
            if (showRationale.size() > 0) {
                new AlertDialog.Builder(WhiteboardLoginActivity.this)
                        .setMessage("Please allow the permissions")
                        .setPositiveButton("OK", (dialog, which) ->
                                ActivityCompat.requestPermissions(WhiteboardLoginActivity.this,
    ...
    private void startCall(String channelId, String userId, String userName) {
        WhiteboardActivity.launch(WhiteboardLoginActivity.this, TokenGenerator.APP_ID, channelId,
