...
public class VideoCallLoginActivity extends AppCompatActivity {
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (getMissedPermission().size() == 0) {
                    ...
                    Toast.makeText(VideoCallLoginActivity.this, "Some permissions are denied", Toast.LENGTH_LONG).show();
                }
                break;
            default:
    ...
    private void joinChannel() {
        ...
        if (missed.size() != 0) {
            ...
            if (showRationale.size() > 0) {
                new AlertDialog.Builder(VideoCallLoginActivity.this)
                        .setMessage("Please allow the permissions")
                        .setPositiveButton("OK", (dialog, which) ->
                                ActivityCompat.requestPermissions(VideoCallLoginActivity.this,
    ...
    private void startCall(String channelId, String userId, String userName) {
        CallActivity.launch(VideoCallLoginActivity.this, TokenGenerator.APP_ID, channelId,
